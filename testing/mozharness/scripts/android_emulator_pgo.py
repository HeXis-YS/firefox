...
WAIT_PAGES = [
    "js-input/webkit/PerformanceTests/JetStream3/index.html",
    "js-input/webkit/PerformanceTests/Speedometer3/index.html?tags=all&iterationCount=3&startAutomatically=true",
    "js-input/webkit/PerformanceTests/MotionMark/index.html",
    "js-input/webkit/PerformanceTests/webaudio/index.html?raptor&rendering-buffer-length=30",
...
class AndroidProfileRun(TestingMixin, BaseScript, MozbaseMixin, AndroidMixin):
    ...
    def wait_for_emulator(self, threshold=20, duration=5):
        ...
        for proc in psutil.process_iter(attrs=['name']):
            if proc.info['name'] in ['qemu-system-x86_64', 'qemu-system-x86_64-headless']:
                qemu_process = proc
                break
        if not qemu_process:
            return False
